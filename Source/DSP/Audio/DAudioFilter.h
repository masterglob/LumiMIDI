...
class BandePassFilter {
 public:
  // Constructeur avec param�tres de fr�quence et de Q
  BandePassFilter(float frequency, float Q);

  // M�thodes surcharg�es de AudioProcessor
 ...
 private:
  float cutoffFrequency;  // Fr�quence de coupure
  float resonance;        // Facteur Q (r�sonance)
