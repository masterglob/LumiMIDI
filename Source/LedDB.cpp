...
const LedContext Led_Gs{"Gs", Led_Line_Gs, Rect(LedWDemo - 100, 100, -100, -50)};
const LedContext Led_Ms{"Ms", Led_Line_Ms, Rect(LedWDemo - 100, 150, -150, 100)};
const LedContext Led_Sh1s{"Sh1s", Led_Line_Sh1s, Rect(LedWDemo - 100, 120, 0, 130)};
const LedContext Led_Sh2s{"Sh2s", Led_Line_Sh2s, Rect(LedWDemo - 200, 70, 0, 130)};
const LedContext Led_SQs{"SQs", Led_Line_SQs, Rect(LedWDemo - 280, 200, 0, 200)};
